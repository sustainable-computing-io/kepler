...
const (
	// waitForMetricsReady: time for Kepler to have stable metrics after startup.
	// Requires ~2-3 collection cycles for reliable readings.
	waitForMetricsReady = 8 * time.Second
