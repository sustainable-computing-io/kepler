...
3. **🎯 Configure alerting** - Set up alerts for energy consumption anomalies
4. **📈 Analyze metrics** - Learn about available metrics in our [Metrics Reference](metrics.md)
5. **🚨 Plan troubleshooting** - Familiarize yourself with our [Troubleshooting Guide](troubleshooting.md)

> **For development workflows:** See the [Developer Getting Started Guide](../developer/getting-started.md)
for building from source, contribution setup, and advanced
