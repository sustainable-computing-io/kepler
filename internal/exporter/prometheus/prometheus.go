...
type Opts struct {
	...
	platformDataProvider collector.PlatformDataProvider
}
...
func WithPlatformDataProvider(provider collector.PlatformDataProvider) OptionFn {
	return func(o *Opts) {
...
func CreateCollectors(pm Monitor, applyOpts ...OptionFn) (map[string]prom.Collector, error) {
	...
	if opts.platformDataProvider != nil {
		collectors["platform"] = collector.NewPlatformCollector(opts.platformDataProvider, opts.logger)
	}
