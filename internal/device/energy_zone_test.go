...
func TestNewAggregatedZone(t *testing.T) {
	zones := []EnergyZone{
		&mockEnergyZone{name: "package-0", index: 0},
		&mockEnergyZone{name: "package-1", index: 1},
	}
...
func TestAggregatedZone_Energy_BasicAggregation(t *testing.T) {
	zones := []EnergyZone{
		&mockEnergyZone{name: "package-0", index: 0, energy: 100, maxEnergy: 1000},
		&mockEnergyZone{name: "package-1", index: 1, energy: 200, maxEnergy: 1000},
	}
...
func TestAggregatedZone_Energy_SingleZone(t *testing.T) {
	zones := []EnergyZone{
		&mockEnergyZone{name: "package-0", index: 0, energy: 150, maxEnergy: 1000},
	}
...
func TestAggregatedZone_Energy_WrapDetection(t *testing.T) {
	zone0 := &mockEnergyZone{name: "package-0", index: 0, energy: 900, maxEnergy: 1000}
	zone1 := &mockEnergyZone{name: "package-1", index: 1, energy: 800, maxEnergy: 1000}
...
func TestAggregatedZone_Energy_MultipleWraps(t *testing.T) {
	zone := &mockEnergyZone{name: "package-0", index: 0, energy: 900, maxEnergy: 1000}
...
func TestAggregatedZone_Energy_ErrorHandling(t *testing.T) {
	zones := []EnergyZone{
		&mockEnergyZone{name: "package-0", index: 0, energy: 100, maxEnergy: 1000, err: fmt.Errorf("read error")},
		&mockEnergyZone{name: "package-1", index: 1, energy: 200, maxEnergy: 1000},
	}
...
func TestAggregatedZone_Energy_AllZonesError(t *testing.T) {
	zones := []EnergyZone{
		&mockEnergyZone{name: "package-0", index: 0, energy: 100, maxEnergy: 1000, err: fmt.Errorf("error1")},
		&mockEnergyZone{name: "package-1", index: 1, energy: 200, maxEnergy: 1000, err: fmt.Errorf("error2")},
	}
...
func TestAggregatedZone_MaxEnergy(t *testing.T) {
	zones := []EnergyZone{
		&mockEnergyZone{name: "package-0", index: 0, maxEnergy: 1000},
		&mockEnergyZone{name: "package-1", index: 1, maxEnergy: 1000},
	}
...
func TestAggregatedZone_ZoneIDGeneration(t *testing.T) {
	zone := &mockEnergyZone{name: "package-0", index: 0, energy: 100, maxEnergy: 1000}
	zones := []EnergyZone{zone}
...
func TestAggregatedZone_StateManagement(t *testing.T) {
	zone := &mockEnergyZone{name: "package-0", index: 0, energy: 500, maxEnergy: 1000}
	zones := []EnergyZone{zone}
...
func TestAggregatedZone_Energy_AggregatedWrapping(t *testing.T) {
	...
	zone0 := &mockEnergyZone{name: "package-0", index: 0, energy: 800, maxEnergy: 1000}
	zone1 := &mockEnergyZone{name: "package-1", index: 1, energy: 900, maxEnergy: 1000}
	zones := []EnergyZone{zone0, zone1}
...
func TestAggregatedZone_CachedMaxEnergy(t *testing.T) {
	...
	zones := []EnergyZone{
		&mockEnergyZone{name: "package-0", index: 0, energy: 100, maxEnergy: 1000},
		&mockEnergyZone{name: "package-1", index: 1, energy: 200, maxEnergy: 1000},
		&mockEnergyZone{name: "package-2", index: 2, energy: 300, maxEnergy: 1000},
	}
